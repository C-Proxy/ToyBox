...
public class CustomMonitorTexture : NetworkPoolableChild
{
    bool m_IsSending;
    ...
    public int monitorId
    {
        ...
        set { monitor = MonitorManager.GetMonitor(value); }
    }
    ...
    void Awake()
    {
        m_DefaultMaterial = MaterialManager.GetMaterial(MaterialName.BlackMetal);
    ...
    void OnEnable()
    {
        ...
        MonitorManager.onReinitialized += Reinitialize;
    }
    ...
    void Reinitialize()
    {
        ...
        monitor = MonitorManager.GetMonitor(lastMonitorId_);
    }
    ...
    {
        public bool hit;
        public CustomMonitorTexture texture;
    ...
    {
        foreach (var uddTexture in GameObject.FindObjectsOfType<CustomMonitorTexture>())
        {
