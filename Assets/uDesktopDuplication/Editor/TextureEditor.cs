...
namespace uDesktopDuplication
{
    ...
    [CustomEditor(typeof(MonitorTexture))]
    public class TextureEditor : Editor
    {
        MonitorTexture texture
        {
            get { return target as MonitorTexture; }
        }
        ...
        void DrawMonitor()
        {
            Fold("Monitor", ref basicsFolded_, () =>
            {
                ...
                var id = EditorGUILayout.Popup("Monitor", monitor.id, MonitorManager.monitors.Select(x => x.name).ToArray());
        ...
        void DrawMaterial()
        {
            Fold("Material", ref matFolded_, () =>
            {
                ...
                texture.meshForwardDirection = (MonitorTexture.MeshForwardDirection)EditorGUILayout.EnumPopup("Mesh Forward Direction", texture.meshForwardDirection);
                ...
                texture.culling = (MonitorTexture.Culling)EditorGUILayout.EnumPopup("Culling", texture.culling);
            });
        }
    }
