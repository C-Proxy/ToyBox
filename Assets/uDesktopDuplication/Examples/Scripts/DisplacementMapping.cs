...
public class DisplacementMapping : MonoBehaviour
{
    ...
    uDesktopDuplication.MonitorTexture uddTexture_;
    ...
    void Update()
    {
        ...
        id = Mathf.Clamp(id, 0, uDesktopDuplication.MonitorManager.monitorCount - 1);
        var monitor = uDesktopDuplication.MonitorManager.GetMonitor(id);
